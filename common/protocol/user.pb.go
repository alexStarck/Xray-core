...
type User struct {
	...
	NumericId     uint32               `protobuf:"varint,6,opt,name=numeric_id,json=numericId,proto3" json:"numeric_id,omitempty"`
...
func (x *User) GetNumericId() uint32 {
	if x != nil {
		return x.NumericId
	}
	return 0
...
const file_common_protocol_user_proto_rawDesc = "" +
	"\n" +
	"\x1acommon/protocol/user.proto\x12\x14xray.common.protocol\x1a!common/serial/typed_message.proto\"\xd1\x01\n" +
	"\x04User\x12\x1f\n" +
	...
	"\aaccount\x18\x05 \x01(\v2 .xray.common.serial.TypedMessageR\aaccount\x12\x1d\n" +
	"\n" +
	"numeric_id\x18\x06 \x01(\rR\tnumericIdB^\n" +
